metadata name = 'ALZ Mini Bicep - Hub Networking Module'
metadata description = 'ALZ Mini Bicep Module used to set up Hub Networking'
...
module modPrivateDnsZones '../privateDnsZones/privateDnsZones.bicep' = if (parPrivateDnsZonesEnabled) {
  ...
  params: {
    parLocation: parLocation
    parTags: parTags
    parVirtualNetworkNameToLink: resHubVnet.name
