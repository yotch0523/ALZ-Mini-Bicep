...
param parLogAnalyticsWorkspaceResourceName string 
var varLogAnalyticsWorkspaceResourceId = resourceId('Microsoft.OperationalInsights/workspaces', parLogAnalyticsWorkspaceResourceName)

@sys.description('Diagnostic Settings Name.')
param parDiagnosticSettingsName string = 'toLogAnalytics'
...
resource mgDiagSet 'Microsoft.Insights/diagnosticSettings@2021-05-01-preview' = {
  ...
  properties: {
    workspaceId: varLogAnalyticsWorkspaceResourceId
    logs: [
      {
