...
param parPrivateDnsZones = [
  // Replace xxxxxx with target region (i.e. eastus)
  'privatelink.xxxxxx.azmk8s.io'
  // Replace xxxxxx with target region (i.e. eastus)
  'privatelink.xxxxxx.batch.azure.com'
  // Replace xxxxxx with target region (i.e. eastus)
  'privatelink.xxxxxx.kusto.windows.net'
  // Replace xxxxxx with target region geo code (i.e. for eastus the geo code is eus)
...
param parVirtualNetworkNameToLink = ''
